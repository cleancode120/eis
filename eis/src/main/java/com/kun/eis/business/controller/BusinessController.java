package com.kun.eis.business.controller;
...
import com.kun.eis.business.service.BusinessService;
...
public class BusinessController {
	...
	public String testHome(@ModelAttribute("searchVO") BusinessVO vo, Model model, HttpSession session) throws Exception {	
	...
	public String testList(@ModelAttribute("searchVO") BusinessVO vo, Model model, HttpSession session) throws Exception {	
		
		// 게시판 UTIL
		BoardUtil boardUtil = new BoardUtil();
		List<BusinessVO> testList = null;
		...
		try {
    	    ...
    	    */
			...
			// 전체 검색 결과
			testList = businessService.testList(vo);
