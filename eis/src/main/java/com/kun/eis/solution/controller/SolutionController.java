package com.kun.eis.solution.controller;
...
import com.kun.eis.solution.service.SolutionService;
...
public class SolutionController {
	...
	public String testHome(@ModelAttribute("searchVO") SolutionVO vo, Model model, HttpSession session) throws Exception {	
	...
	public String testList(@ModelAttribute("searchVO") SolutionVO vo, Model model, HttpSession session) throws Exception {	
		
		// 게시판 UTIL
		BoardUtil boardUtil = new BoardUtil();
		List<SolutionVO> testList = null;
		...
		try {
    	    ...
    	    */
			...
			// 전체 검색 결과
			testList = solutionService.testList(vo);
	...
	@ResponseBody
	public Object procEqpmntManage(@ModelAttribute("vo") SolutionVO vo, Model model, HttpSession session) throws Exception {	
		
		HashMap<String, Object> resultMap = new HashMap<String, Object>();
		// 결과 성공여부
		boolean rstFlag = false;
		SolutionVO solutionVO = null;
		
		try {
		    			
			solutionVO = solutionService.selectPwCode(vo);
			rstFlag = true;
			...
			resultMap.put("solutionVO", solutionVO);
		}
